...
synopsis :: String
synopsis = "Position in an append-only log \8212 what is new since I last asked"
-- |The content of the @copyright@ field of the package's Cabal file.
copyright :: String
copyright = "Tony Day (c) 2026"
-- |The content of the @homepage@ field of the package's Cabal file.
homepage :: String
homepage = "https://github.com/tonyday567/cursor"
